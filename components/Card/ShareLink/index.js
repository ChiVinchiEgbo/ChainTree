          ...
          <div className="flex min-w-full flex-col items-center justify-between px-6 py-5 lg:flex-row lg:items-center">
            ...
            <div className="mt-4 flex flex-col items-center">
              ...
              <a
                ...
                id={`share-twitter`}
                href={`https://twitter.com/intent/tweet?text=Novo curso 100%25 gratuito da ChainTree sobre Smart Contracts, ainda vou ganhar um NFT no final, eu já me inscrevi, e você? ${shortenedUrl}`}
                target="_blank"
                data-size="large"
              >
                {t('shareButton')}
