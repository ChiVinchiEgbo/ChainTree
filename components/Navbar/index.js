      ...
      <Navbar variant={'floating'} isBordered={true}>
        <Navbar.Brand css={{ gap: '$5' }}>
          <Link href="/">
            ...
            <Text weight={'bold'}>ChainTree</Text>
          </Link>
          <ThemeSwitch />
        </Navbar.Brand>
        ...
        <Navbar.Content>
          {user?.uid && (
            <Navbar.Content hideIn={'md'}>
              <NUButton
                auto="true"
                css={{ background: '#56F569', color: '#010101' }}
                color={''}
                onPress={() => setVisible(true)}
              >
                <Text weight={'bold'} css={{ color: '#010101' }}>{t('indicateAndWin')}</Text>
              </NUButton>
              <Modal
                scroll
                width="600px"
          ...
          {user && (
            <div>
              ...
              <Navbar.CollapseItem
                ...
                css={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}
              >
                <Button css={{ background: '#56F569', color: '#010101' }} color={''} onPress={() => setVisible(true)}>
                  <Text weight={'bold'} css={{ color: '#010101' }}>{t('indicateAndWin')}</Text>
                </Button>
              </Navbar.CollapseItem>
            </div>
