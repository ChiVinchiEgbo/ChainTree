...
export default function FAQPage() {
  ...
  return (
    <>
      <SEOHead
        title="Frequently Asked Questions (FAQ) - ChainTree"
        description="Find answers to common questions about ChainTree bootcamp. Learn about courses, NFT certificates, enrollment, community support, and getting started with Web3."
        canonical="/faq"
        keywords={[
          'chaintree faq',
          'bootcamp questions',
          ...
          'chaintree perguntas frequentes',
        ]}
      ...
      <div className="mx-auto max-w-4xl px-6 py-10">
        ...
        <p className="mb-10 text-base text-gray-600 dark:text-gray-400">
          Find answers to common questions about ChainTree bootcamp. Can&apos;t find what
          you&apos;re looking for?{' '}
          <a
            href="https://t.me/chaintree"
            target="_blank"
