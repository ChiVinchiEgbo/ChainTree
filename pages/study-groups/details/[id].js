...
function Course({ course }) {
    ...
    return (
        ...
        <SEOHead
            ...
            description={course.description ? course.description.substring(0, 160) : `Learn ${course.title} with ChainTree Bootcamp. Free Web3 course with NFT certificate.`}
            canonical={`/study-groups/details/${course.id}`}
            ogImage={course.image_url || `${SITE_URL}/og/og-course-default.png`}
            ogImageAlt={`${course.title} - ChainTree Bootcamp`}
        />
