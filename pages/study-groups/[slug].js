  ...
  return (
    <>
      <SEOHead
        ...
        description={groupDescription ? groupDescription.replace(/<[^>]*>/g, '').substring(0, 160) : 'Join this ChainTree study group to learn Web3 development collaboratively with the community.'}
