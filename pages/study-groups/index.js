  ...
  return (
    <>
      <SEOHead
        ...
        description="Join ChainTree study groups to learn Web3 development collaboratively. Find weekly sessions on blockchain, smart contracts, NFTs, and DeFi. Free and open to all."
        canonical="/study-groups"
        keywords={['web3 study groups', 'blockchain study group', 'learn web3 together', 'smart contract group', 'solana study group']}
        ogImage={`${SITE_URL}/og/og-study-groups.png`}
        ogImageAlt="ChainTree Study Groups - Learn Web3 Together"
