...
// Inicializa o Firebase Admin SDK para o chaintree-bootcamp
const bootcampApp = admin.initializeApp(
  {
    credential: admin.credential.applicationDefault(),
    databaseURL: 'https://chaintree-bootcamp.firebaseio.com',
    projectId: 'chaintree-bootcamp',
  },
  'bootcamp'
)
...
// Inicializa o Firebase Admin SDK para o chaintree-development
