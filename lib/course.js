...
export const defaultCourse = {
  ...
  title: 'Build your First Smart Contract with Solidity',
  description:
    'A 9-day project where you will learn Solidity, write and deploy smart contracts on the blockchain, and build a Web3 App to interact with your contract. Perfect for blockchain enthusiasts and Web3 developers.',
  image_url: '/assets/img/solidity_course_cover.png',
  active: true,
}
